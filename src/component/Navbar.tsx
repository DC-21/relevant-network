...
const NavBar = () => {
  ...
  return (
    <nav className="flex items-center max-w-7xl font-bold text-white md:mt-2 mt-0 md:rounded rounded-none bg-[#353935] top-0 z-50 bg-opacity-[98%] backdrop-blur w-full justify-between px-2 md:px-6 py-7">
